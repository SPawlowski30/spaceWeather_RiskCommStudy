...
base_url = "https://www.ngdc.noaa.gov/stp/space-weather/swpc-products/daily_reports/discussion/"

# list of years 2024 - 2025
years = list(range(2024, 2026))  # 2024 to 2025
...
df.to_csv("Forecast_Discussion.csv", index=False)
